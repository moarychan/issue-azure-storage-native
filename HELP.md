...
* The following dependencies are not known to work with Spring Native: 'Azure Support, Azure Storage'. As a result, your application may not work as expected.
* The original package name 'com.example.demo-azure-storage-native' is invalid and this project uses 'com.example.demoazurestoragenative' instead.
...
```
$ docker run --rm -p 8080:8080 demo-azure-storage-native:0.0.1-SNAPSHOT
```
...
```
$ target/demo-azure-storage-native
```
